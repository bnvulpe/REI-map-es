...
<qgis hasScaleBasedVisibilityFlag="0" minScale="3e+06" version="3.34.15-Prizren" maxScale="0" autoRefreshMode="Disabled" autoRefreshTime="0" styleCategories="AllStyleCategories">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" band="1" enabled="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol type="line" is_animated="0" clip_to_extent="1" force_rhr="0" name="" alpha="1" frame_rate="10">
        ...
        <layer id="{9f0645d7-01bd-4621-b8d3-3b40935c09be}" class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" is_animated="0" clip_to_extent="1" force_rhr="0" name="" alpha="1" frame_rate="10">
        ...
        <layer id="{eed6f469-4c84-4d4c-9c6e-3f8fb61259b2}" class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
  ...
  <pipe>
    ...
    <brightnesscontrast gamma="1.12" contrast="-39" brightness="-35"/>
    <huesaturation colorizeGreen="148" saturation="-100" invertColors="0" colorizeStrength="13" grayscaleMode="2" colorizeBlue="200" colorizeRed="209" colorizeOn="0"/>
