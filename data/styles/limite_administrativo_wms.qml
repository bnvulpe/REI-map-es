...
<qgis hasScaleBasedVisibilityFlag="0" minScale="1e+08" version="3.34.15-Prizren" maxScale="0" autoRefreshMode="Disabled" autoRefreshTime="0" styleCategories="AllStyleCategories">
  <flags>
  ...
  <elevation zoffset="0" zscale="1" band="1" enabled="0" symbology="Line">
    ...
    <profileLineSymbol>
      <symbol type="line" is_animated="0" clip_to_extent="1" force_rhr="0" name="" alpha="1" frame_rate="10">
        ...
        <layer id="{de545028-43f1-4976-9958-839b99cde682}" class="SimpleLine" pass="0" enabled="1" locked="0">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol type="fill" is_animated="0" clip_to_extent="1" force_rhr="0" name="" alpha="1" frame_rate="10">
        ...
        <layer id="{658a8001-328b-42a8-9500-0e98f795871b}" class="SimpleFill" pass="0" enabled="1" locked="0">
          <Option type="Map">
  ...
  <pipe>
    ...
    <brightnesscontrast gamma="1" contrast="10" brightness="-60"/>
    <huesaturation colorizeGreen="128" saturation="-100" invertColors="0" colorizeStrength="100" grayscaleMode="0" colorizeBlue="128" colorizeRed="255" colorizeOn="0"/>
